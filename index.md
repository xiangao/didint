...
Standard DiD assumes one unit’s outcome does not depend on another
unit’s treatment. That is often too strong for spatial policies. A
treated municipality can affect nearby municipalities, so the estimand
has to say what exposure level is being compared.
